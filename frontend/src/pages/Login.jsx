...
export default function Login() {
  ...
  return (
    <div className="flex items-center justify-center pt-20 min-w-screen bg-gray-50 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-sm sm:max-w-md lg:max-w-lg bg-white p-8 rounded-xl shadow">
        <h2 className="text-2xl font-bold mb-4 text-indigo-700 text-center">Login</h2>
